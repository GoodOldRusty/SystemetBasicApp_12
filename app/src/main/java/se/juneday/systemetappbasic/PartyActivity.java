    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        park_party_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent park = new Intent (PartyActivity.this, MainActivity.class);
                startActivity(park);
            }
        });
        new_year_party_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent new_year = new Intent (PartyActivity.this, MainActivity.class);
        ...
        exam_party_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent exam = new Intent (PartyActivity.this, MainActivity.class);
                startActivity(exam);
            }
        });
        home_party_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent home = new Intent (PartyActivity.this, MainActivity.class);
                startActivity(home);
            }
        });
    }
